...
|  [createRouter](./kibana-plugin-server.httpservicesetup.createrouter.md) | <code>&lt;Context extends RequestHandlerContext&gt;() =&gt; IRouter&lt;Context&gt;</code> | Provides ability to declare a handler function for a particular path and HTTP request method. |
